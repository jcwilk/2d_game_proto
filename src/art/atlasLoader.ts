...
/** Sprite-ref JSON for the character walk preset (`tools/sprite-generation/presets/character/character.mjs`). */
...
/** Frame keys and load order — keep in sync with `CHARACTER_WALK_FRAMES` in `tools/sprite-generation/presets/character/character.mjs`. */
